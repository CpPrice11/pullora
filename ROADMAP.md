# Roadmap Air Launcher після v2.3.0
...
### v2.3.0 - About Version Center

- `Про застосунок` стало повноцінним центром версій лаунчера.
- Додано компактний стан лаунчера: актуальність, portable mode, rollback availability і cleanup estimate.
- Додано дії: відкрити папку лаунчера, відкрити GitHub release, скопіювати діагностику, очистити старі self-update файли.
- Список релізів отримав фільтри `Усі`, `Rollback`, `Поточна`, `Старі`.
- Release rows ущільнено, поточна версія показується badge замість disabled-кнопки.
- Додано preview release notes без переходу на GitHub.
- Confirm update/rollback показує поточну версію, цільову версію, asset і папку лаунчера.
- Cleanup залишає найсвіжіший backup як fallback.

## Next Milestones

### v2.4.0 - Install Engine 2 Recovery
...
### v2.5.0 - App Details Local Versions Polish
...
Recommended next implementation milestone: `v2.4.0 - Install Engine 2 Recovery`.
