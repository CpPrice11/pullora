...
try {
  ...
  assert.match(workspaceCropDialogMarkup, /class="art-crop-grid"/)
  assert.match(workspaceCropDialogMarkup, /\u041c\u0456\u0439 \u0435\u043a\u0440\u0430\u043d: 1920 \u00d7 1080/)
  assert.match(workspaceCropDialogMarkup, /aspect-ratio:1\.777/)
  ...
  assert.match(artCropDialogSource, /onWheel=\{handleWheel\}/)
  assert.match(artCropDialogSource, /pointersRef[\s\S]*?pinchRef/)
